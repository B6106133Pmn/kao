...
func (e DegreeEdges) DoctorOrErr() ([]*Doctor, error) {
	if e.loadedTypes[0] {
		return e.Doctor, nil
	}
...
// QueryDoctor queries the doctor edge of the Degree.
func (d *Degree) QueryDoctor() *DoctorQuery {
	return (&DegreeClient{config: d.config}).QueryDoctor(d)
}
